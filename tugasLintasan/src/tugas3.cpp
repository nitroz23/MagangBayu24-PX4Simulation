...
int missionStep = 0;
float droneX[10] = {0.00, -2.70, -2.70, -1.00, -1.00, -1.00, -1.00, -2.70, -2.70, 0.00};
float droneY[10] = {0.00, 0.90, 0.90, -1.40, -1.40, 1.40, 1.40, -0.90, -0.90, 0.00};
float droneZ = -5.00;
float droneRad = 0.00;
    ...
    MissionControl() : Node("mission_control")
    {
        ...
        auto timerCallback = [this]() -> void {
            ...
            if (offboardSetpointCounter_ % 40 == 0 && offboardSetpointCounter_ > 40 && missionStep < 10){
                missionStep++;
                if (missionStep % 2 == 0){droneRad += 2.51327;}
            } 
